...
<body>
    @include('header')
    <main
        class="max-w-2xl mx-auto mt-12 bg-[#111827] p-10 rounded-2xl shadow-2xl shadow-purple-500/60 border border-pink-400/30">
        ...
        <form method="post" action="msc.php" enctype="multipart/form-data" class="space-y-6">
            @csrf
            <div>
                <label for="musica_favorita" class="block text-purple-300 font-medium mb-1">Digite uma das suas músicas
                    favoritas da Taylor Swift:</label>
            ...
            <div>
                <label for="numero_musica" class="block text-purple-300 font-medium mb-1">Digite o número dela no álbum
                    (1ª - 1, 2ª - 2):</label>
                <input type="number" name="numero_musica" id="numero_musica" min="1" max="31"
                    placeholder="5"
                    class="w-full px-4 py-2 bg-[#1F2937] text-gray-200 border border-pink-500 rounded focus:outline-none focus:ring-2 focus:ring-sky-200" />
            </div>

            <div>
                <label for="album_musica" class="block text-purple-300 font-medium mb-1">Qual álbum (ou EP) esta música
                    pertence?</label>
                <select name="album_musica" id="album_musica" required
                    ...
                    <option value="16" class="text-pink-400">THE TORTURED POESTS DEPARTAMENT: THE ANTHOLOGY (2024)
                    </option>
            ...
            <div>
                <label for="genero_musica" class="block text-purple-300 font-medium mb-1">Qual o gênero desta
                    música?</label>
            ...
            <div>
                ...
                <textarea name="descricao_musica" id="descricao_musica" rows="4"
                    placeholder="Digite aqui sua opinião ou um trecho da música..."
            ...
            <div>
                <label for="imagem_musica" class="block text-purple-300 font-medium mb-3">Selecione uma imagem que lhe
                    remeta à música:</label>
